...
<?php 
    ...
    if (isset($_POST['book'])) {
        ...
        if (empty($bplace) || empty($bdate) || empty($phno) || empty($des) || empty($rdate)) {
            ...
            if ($bdate < $rdate) {
                $price = $carprice; // price doesn't depend on duration anymore
                $sql = "INSERT INTO booking (CAR_ID, EMAIL, BOOK_PLACE, BOOK_DATE, PHONE_NUMBER, DESTINATION, PRICE, RETURN_DATE) 
                        VALUES ($carid, '$uemail', '$bplace', '$bdate', $phno, '$des', $price, '$rdate')";
    ...
    <div class="register">
        ...
        <form id="register" method="POST">
            ...
            <select name="place" id="place">
                ...
                <option value="Bonda Factory">Adyar Katte</option>
                <option value="Bonda Factory">Tandoor Kitchen</option>
                <option value="Bonda Factory">Bonda Factory</option>
            ...
            <br>
            <input type="date" name="date" id="datefield" min='01-01-1899' placeholder="Enter the date for booking">
            <br><br>
            ...
            <br>
            <input type="date" name="rdate" id="dfield" min='01-01-1899' placeholder="Enter the return date">
            <br><br>
